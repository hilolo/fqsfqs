...
const ConnectButton = styled(WalletMultiButton)`
  ...
  padding: 6px 16px;
  background-image: url('connect wallet.svg');
                    ...
                    <DesContainer>
                        <NFT elevation={3}>
                            ...
                            <div><Price
                                ...
                                src="Logo pengsol.svg"
                                alt="NFT To Mint"/></div>
                            <h5   >PENGSOL</h5>
                            <h4><b>4444 Pengs</b> with a conscience </h4>
                            <h4>pengsol is your AI <b>companion</b> that will automate your NFT journey  </h4>
